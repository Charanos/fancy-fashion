  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="glyph-heart-shadow" x="-20%" y="-20%" width="140%" height="150%">
        ...
        <linearGradient id="glyph-heart-body" x1="12" y1="2" x2="12" y2="22" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="glyph-heart-rim" x1="4" y1="3" x2="20" y2="18" gradientUnits="userSpaceOnUse">
        ...
        {/* Inner Glint */}
        <linearGradient id="glyph-heart-glint" x1="7" y1="5" x2="10" y2="9" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill="url(#glyph-heart-body)"
        filter="url(#glyph-heart-shadow)"
      />

      {/* 3D Chamfer / Bevel Stroke */}
      <path
        d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
        stroke="url(#glyph-heart-rim)"
        strokeWidth="0.8"
        strokeLinejoin="round"
      />

      {/* Top Left Specular Glint */}
      <ellipse cx="7.2" cy="6.2" rx="2.2" ry="1.2" transform="rotate(-30 7.2 6.2)" fill="url(#glyph-heart-glint)" />
    </svg>
  );
}
...
export function GlyphShoppingBag({
  ...
  return (
    ...
    >
      <defs>
        <filter id="glyph-bag-shadow" x="-20%" y="-20%" width="140%" height="150%">
          <feDropShadow dx="0" dy="1.5" stdDeviation="1" floodColor="rgba(24, 20, 16, 0.35)" />
          <feDropShadow dx="0" dy="0.5" stdDeviation="0.4" floodColor="rgba(255, 255, 255, 0.8)" />
        </filter>

        {/* Bag Body 3D Gradient */}
        <linearGradient id="glyph-bag-body" x1="12" y1="6" x2="12" y2="22" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="glyph-bag-handle" x1="12" y1="2" x2="12" y2="10" gradientUnits="userSpaceOnUse">
        ...
        {/* Bevel Rim */}
        <linearGradient id="glyph-bag-rim" x1="5" y1="6" x2="19" y2="21" gradientUnits="userSpaceOnUse">
        ...
        {/* Front Crease Shadow */}
        <linearGradient id="glyph-bag-crease" x1="12" y1="7" x2="12" y2="19" gradientUnits="userSpaceOnUse">
      ...
      {/* Bag Body */}
      <path
        d="M4.8 8.8C4.6 7.8 5.3 7 6.3 7h11.4c1 0 1.7.8 1.5 1.8l-1.6 10.8c-.1.9-.9 1.4-1.8 1.4H8.2c-.9 0-1.7-.5-1.8-1.4L4.8 8.8z"
        fill="url(#glyph-bag-body)"
        filter="url(#glyph-bag-shadow)"
      />

      {/* Bag Rim Highlight */}
      <path
        d="M4.8 8.8C4.6 7.8 5.3 7 6.3 7h11.4c1 0 1.7.8 1.5 1.8l-1.6 10.8c-.1.9-.9 1.4-1.8 1.4H8.2c-.9 0-1.7-.5-1.8-1.4L4.8 8.8z"
        stroke="url(#glyph-bag-rim)"
        strokeWidth="0.8"
      />
...
export function GlyphUser({
  ...
  return (
    ...
    >
      <defs>
        <filter id="glyph-user-shadow" x="-20%" y="-20%" width="140%" height="150%">
          <feDropShadow dx="0" dy="1.5" stdDeviation="1" floodColor="rgba(24, 20, 16, 0.35)" />
          <feDropShadow dx="0" dy="0.5" stdDeviation="0.4" floodColor="rgba(255, 255, 255, 0.8)" />
        </filter>

        {/* 3D Sphere Head Gradient */}
        <radialGradient id="glyph-user-head" cx="35%" cy="30%" r="65%">
        ...
        {/* 3D Torso Gradient */}
        <linearGradient id="glyph-user-torso" x1="12" y1="13" x2="12" y2="21" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#554f47" />
        ...
        <linearGradient id="glyph-user-rim" x1="6" y1="4" x2="18" y2="20" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#ffffff" stopOpacity="0.8" />
      ...
      <circle
        ...
        cy="7.5"
        r="4.2"
        fill="url(#glyph-user-head)"
        stroke="url(#glyph-user-rim)"
        strokeWidth="0.7"
        filter="url(#glyph-user-shadow)"
      />
...
export function GlyphSearch({
  ...
  return (
    ...
    >
      <defs>
        <filter id="glyph-search-shadow" x="-20%" y="-20%" width="140%" height="150%">
          <feDropShadow dx="0" dy="1.2" stdDeviation="0.8" floodColor="rgba(24, 20, 16, 0.35)" />
          <feDropShadow dx="0" dy="0.5" stdDeviation="0.4" floodColor="rgba(255, 255, 255, 0.8)" />
        </filter>

        {/* Lens Rim Metallic Gradient */}
        <linearGradient id="glyph-lens-rim" x1="4" y1="4" x2="16" y2="16" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient id="glyph-lens-glass" cx="35%" cy="35%" r="65%">
        ...
        {/* Handle Gradient */}
        <linearGradient id="glyph-search-handle" x1="14" y1="14" x2="21" y2="21" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        stroke="url(#glyph-search-handle)"
        strokeWidth="2.4"
        strokeLinecap="round"
        filter="url(#glyph-search-shadow)"
      />

      {/* Lens Interior Glass */}
      <circle cx="10" cy="10" r="6.2" fill="url(#glyph-lens-glass)" />
...
export function GlyphMenu({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="glyph-bar-grad" x1="4" y1="0" x2="4" y2="4" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#554f47" />
          <stop offset="60%" stopColor="#35302a" />
          <stop offset="100%" stopColor="#181512" />
        </linearGradient>
        <filter id="glyph-bar-shadow" x="-10%" y="-20%" width="120%" height="160%">
      ...
      <rect
        ...
        height="2.5"
        rx="1.25"
        fill="url(#glyph-bar-grad)"
        stroke="#ffffff"
        strokeOpacity="0.4"
        strokeWidth="0.5"
        filter="url(#glyph-bar-shadow)"
      />
...
export function GlyphCompassLogo({
  ...
  return (
    <div
      className={`relative inline-grid place-items-center rounded-full transition-transform duration-300 group-hover:scale-105 ${className}`}
      style={{
        width: size,
        height: size,
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="compass-brass" x1="6" y1="3" x2="18" y2="21" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="compass-steel" x1="12" y1="2" x2="12" y2="22" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#696258" />
            <stop offset="50%" stopColor="#3f3a34" />
            <stop offset="100%" stopColor="#1a1815" />
          </linearGradient>
          <filter id="compass-shadow" x="-20%" y="-20%" width="140%" height="150%">
            <feDropShadow dx="0" dy="1" stdDeviation="0.6" floodColor="rgba(24, 20, 15, 0.3)" />
          </filter>
        </defs>

        {/* Pivot Top Knob */}
        <circle cx="12" cy="4.2" r="1.8" fill="url(#compass-brass)" filter="url(#compass-shadow)" />
        <circle cx="11.5" cy="3.7" r="0.6" fill="#ffffff" fillOpacity="0.7" />

        {/* Compass Legs */}
        <path
          d="M12 5.5L7 20"
          stroke="url(#compass-steel)"
          strokeWidth="1.8"
          strokeLinecap="round"
        ...
        <path
          d="M8.5 13.5a6 6 0 0 1 7 0"
          stroke="url(#compass-brass)"
          strokeWidth="1.2"
          strokeLinecap="round"
        />
        <circle cx="12" cy="13.2" r="1.2" fill="url(#compass-brass)" />
